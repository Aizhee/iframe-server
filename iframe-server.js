...
var iframeServer = require("./index");
...
var configPath = path.join(homeDir, '.iframe-server.json');
...
for (var i = process.argv.length - 1; i >= 2; --i) {
	...
	if (arg.indexOf("--port=") > -1) {
		...
		setTimeout(iframeServer.shutdown, 500);
		process.argv.splice(i, 1);
	} else if (arg.indexOf("--inject-js=") > -1) {
		opts.injectJS = arg.substring(12);
		process.argv.splice(i, 1);
	}
}
